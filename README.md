...
[Spring Boot's starter parent]: http://docs.spring.io/spring-boot/docs/1.2.0.RELEASE/reference/html/using-boot-build-systems.html#using-boot-maven-parent-pom
[Spring Boot's Maven plugin]: http://docs.spring.io/spring-boot/docs/1.2.0.RELEASE/reference/html/build-tool-plugins-maven-plugin.html
[Spring Boot's Gradle plugin]: http://docs.spring.io/spring-boot/docs/1.2.0.RELEASE/reference/html/build-tool-plugins-gradle-plugin.html
